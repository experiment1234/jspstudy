...
public class ResponseServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * 응답(Response)
		 * 1. 서버가 클라이엔트에게 데이터를 보내는것을 응답이라고 한다. 
	...
	// IOException 예외 처리가 필요하지만 doGet() 메소드는 IOException 처리를 이미 하고 있
	...
	// 5.응답하기(온전한 웹 페이지) 
	 	...
	 	out.println("<head>");
	 	out.println("<meta chareset=\"UTF-8\">");
	 	out.println("<title>페이지지목</title>");
	 	out.println("<style>");
	 	out.println(".wrap{");
